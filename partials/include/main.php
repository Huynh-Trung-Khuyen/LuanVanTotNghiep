...
<div class="row justify-content-center">
    <div class="col-md-10 mb-5 text-center">
        <ul class="product-category">
            <li><a href="../../public/shop/category_menu.php">All</a></li>
    ...
    <div class="row">
        <?php for ($i = $start; $i < $end && $i < count($products); $i++) : ?>
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="product">
                    <a href="../../public/shop/product_detail.php?id=<?php echo $product['product_id'] ?>" class="img-prod">
                    ...
                    <div class="text py-3 pb-4 px-3 text-center">
                        <h3><a href="../../public/shop/product_detail.php?id=<?php echo $product['product_id'] ?>"><?php echo $product['product_name']; ?></a></h3>
