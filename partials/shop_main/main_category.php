    ...
    <div class="container">
        ...
        <?php foreach ($results as $row) : ?>
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="product">
                        <a href="../../public/shop/product_detail.php?id=<?php echo $row['product_id'] ?>" class="img-prod">
                        ...
                        <div class="text py-3 pb-4 px-3 text-center">
                            <h3><a href="../../public/shop/product_detail.php?id=<?php echo $row['product_id'] ?>"><?php echo $row['product_name']; ?></a></h3>
