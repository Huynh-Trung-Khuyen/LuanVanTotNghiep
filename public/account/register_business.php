...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!isset($error)) {
        ...
        if ($user) {
            ...
            $_SESSION['user']['role'] = $defaultRole;
        ...
        <div class="col-12 col-md-9 col-lg-7 col-xl-7">
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-5">
              ...
              <p class="text-center text-muted mt-5 mb-0">Bạn đã có tài khoản? <a href="./login.php" class="fw-bold text-body"><u>Login here</u></a></p>
