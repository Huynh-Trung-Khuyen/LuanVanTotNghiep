...
$query = $conn->prepare('SELECT p.product_id, p.product_name, p.price, p.image, p.warehouse_id, p.category_id, w.imported_product_name, c.category_name, w.quantity, w.supplier_id, w.purchase_price
                          FROM product p
                                        ...
                                        <tbody>
                                            <?php foreach ($productsToDisplay as $product) : ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $product['price'] - $product['purchase_price']; ?>.000vnđ/Kg</td>
