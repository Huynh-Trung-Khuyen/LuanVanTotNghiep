...
$id = $_GET['id'];
$query = $conn->prepare('SELECT * FROM warehouse_bid WHERE warehouse_bid_id = :id');
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = $conn->prepare('
        UPDATE warehouse_bid
        SET imported_bid_name = :imported_bid_name, 
            quantity = :quantity, 
            input_day = :input_day, 
            expired_date = :expired_date, 
            seri_number = :seri_number
        WHERE warehouse_bid_id = :id
    ');
    $query->bindParam(':id', $id);
    $query->bindParam(':imported_bid_name', $imported_product_name);
    ...
    <div class="wrapper">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="imported_product_name" value="<?php echo $row['imported_bid_name'] ?>" class="form-control" placeholder="Nhập tên sản phẩm nhập kho">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
        ...
        <?php if (isset($success)) : ?>
            <div style="width: 300px;" class="alert alert-success alert-dismissible">
                <button type="button" class a="btn-close" data-bs-dismiss="alert"></button>
