...
$query = $conn->prepare('
    SELECT * FROM `order` WHERE role = 3 LIMIT :start, :items_per_page
');
...
$count_query = $conn->prepare('SELECT COUNT(*) FROM `order` WHERE role = 3');
$count_query->execute();
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Đơn Hàng Thất Bại</h1>
                        </div>
                    </div>
                </div>
            </div>
